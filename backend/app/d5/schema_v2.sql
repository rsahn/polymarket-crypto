...
CREATE TABLE IF NOT EXISTS schema_info(version INTEGER PRIMARY KEY CHECK(version=2));
INSERT OR IGNORE INTO schema_info VALUES(2);
CREATE TABLE IF NOT EXISTS sessions(
 session_id TEXT PRIMARY KEY, started_at_ms INTEGER NOT NULL, ended_at_ms INTEGER,
 code_version TEXT NOT NULL, schema_version INTEGER NOT NULL CHECK(schema_version=2),
...
CREATE TABLE IF NOT EXISTS events(
 ...
 generation INTEGER, payload_json BLOB NOT NULL,
...
CREATE TABLE IF NOT EXISTS book_sides(
 ...
 spread REAL, bids_json BLOB NOT NULL, asks_json BLOB NOT NULL, source_hash TEXT, sequence TEXT,
...
CREATE TABLE IF NOT EXISTS anchors(
 ...
 event_ts_ms INTEGER, received_ts_ms INTEGER NOT NULL, available_ts_ms INTEGER NOT NULL,
 expiry_ts_ms INTEGER NOT NULL, features_json BLOB NOT NULL,
...
BEGIN
 ...
 THEN RAISE(ABORT,'CROSS_MARKET_REJECT') END;
END;
CREATE INDEX IF NOT EXISTS idx_d5_anchor_lifecycle ON anchors(session_id,anchor_condition_id,anchor_market_slug,status);
