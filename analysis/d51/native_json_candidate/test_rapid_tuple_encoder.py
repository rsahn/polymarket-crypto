...
from rapid_tuple_encoder import encode
...
class EncoderTests(unittest.TestCase):
    def test_values_types_unicode_and_float_bits(self):
        cases = [None,True,False,{},[],[1,1.0,-0.0,0.0,5e-324,1e308,1e-20],{'Ã©':'ðŸ˜€','x':'\ud800'},[2**100,-2**100],{'a':(1,2.0)}, {1:'x'}, {'x':[float.fromhex('0x1.fffffffffffffp+1023')]}]
        for value in cases:
