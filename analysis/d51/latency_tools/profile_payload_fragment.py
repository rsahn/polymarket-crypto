...
spec=importlib.util.spec_from_file_location('fragments',ROOT/'analysis/d51/payload_fragment_candidate/candidate.py');mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod);Store=mod.FragmentStore
...
out=ROOT/'analysis/d51'/('payload_fragment_profile_'+datetime.datetime.now().strftime('%Y%m%d_%H%M%S'));out.mkdir(exist_ok=False)
