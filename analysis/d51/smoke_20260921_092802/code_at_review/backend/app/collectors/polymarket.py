...
class PolymarketMarketDiscovery:
    ...
    @staticmethod
    def fetch_active_markets(verify_tls: bool = False) -> List[Dict[str, Any]]:
        ...
        for minutes in (5, 15):
            ...
            for candidate in (start_s, start_s - window_s, start_s + window_s):
                ...
                try:
                    ...
                    if verify_tls and not (isinstance(exc, HTTPError) and exc.code == 404):
                        raise
                    continue
    ...
    @staticmethod
    def get_active_btc_markets(verify_tls: bool = False, raise_errors: bool = False) -> List[Dict[str, Any]]:
        try:
            markets = PolymarketMarketDiscovery.fetch_active_markets(verify_tls=verify_tls)
