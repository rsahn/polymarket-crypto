...
from app.live.collateral_onchain import PublicRPC,RPC,CTF
...
def run():
    ...
    report={'phase':'CTF_RPC_FAILURE_DIAGNOSTIC','status':'BLOCKED','rpc':RPC,
    ...
    try:
        ...
        wallet=expected_wallet();rpc=PublicRPC(wallet)
